...
@Data
@AllArgsConstructor
@Schema(description = "DTO representing a withdrawal request")
public class WithdrawDTO {

    @Schema(description = "Account number from which the amount will be withdrawn",
    ...
    @Schema(description = "Amount to withdraw",
            example = "500.00")
